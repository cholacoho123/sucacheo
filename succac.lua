...
getgenv().Config = {
    ...
    -- Webhook (tùy chọn)
    WebhookUrl = 'https://discord.com/api/webhooks/1386629644140417145/rXZ-L2AWqC2p-dzbGULNBLoKmQiJ7tvUrPIhsFT5DcysdOvid77952-1jVKi4hOiq0qs',
    SendAllPets = false,
    PetFilter = {
        'Tiger',
        'Swan',
